...
Helpers.prototype.comment = function comment(element) {
  ...
  if (cfg.ssi && (~element.data.indexOf('#include')||~element.data.indexOf('#echo var')||~element.data.indexOf('#set var')||~element.data.indexOf('#if expr')||~element.data.indexOf('#endif')||~element.data.indexOf('#else')||~element.data.indexOf('#printenv')||~element.data.indexOf('#config')||~element.data.indexOf('#flast')||~element.data.indexOf('#fsize'))) return io();
